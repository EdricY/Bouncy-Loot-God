...
quest_data_table = {
    ...
    "Crazy About You":                                      BL2ArchiData("Rustyards", 15, req_items=["License: Common Pistol"], tags=["story", "unlocked_remove"]),
...
loc_data_table = {
    ...
    "Challenge Wurmwater: Refined Tastes":                                 BL2ArchiData("Wurmwater", 15, req_items=["License: Common Pistol"], story_req_regions=["Rustyards"], tags=["reg-based"]),
    ...
    "Chest Wurmwater: Refined Tastes":                              BL2ArchiData("Wurmwater", 15, req_items=["License: Common Pistol"], story_req_regions=["Rustyards"]),
