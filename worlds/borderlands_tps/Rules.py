...
def set_world_rules(world: BorderlandsTPSWorld):
    ...
    try_add_rule(world.try_get_entrance("Serenity's Waste to Concordia"),
                 lambda state: state.can_reach("Regolith Range", world.player) and state.can_reach_location("Quest: Lost Legion Invasion", world.player))
    ...
    try_add_rule(world.try_get_entrance("Outlands Pumping Station to Tycho's Ribs"),
                 lambda state: state.can_reach_location("Quest: Eye to Eye", world.player))
