...
quest_data_table = {
    ...
    "Corrosion of Dignity":                                 BLTPSArchiData("Motherlessboard", 30, req_locations=["Quest: Enter the Claptrap"], req_items=["Crouch"], req_groups=["Oz Kit"], is_non_gear_reward=True), # level 32
