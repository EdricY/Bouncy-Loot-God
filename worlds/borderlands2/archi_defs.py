...
loc_data_table = {
    ...
    "Enemy: BNK-3R":                                 BL2ArchiData("Bunker", 24, req_items=["License: Common Pistol"], tags=["story"], alternates=[
    ...
    "Chest Bunker: Back Room":                                      BL2ArchiData("Bunker", 24, req_items=["License: Common Pistol"]),
