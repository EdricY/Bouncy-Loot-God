...
region_data_table: Dict[str, Borderlands2RegionData] = {
    ...
    "Burrows": Borderlands2RegionData("Burrows", 30, 30, "Travel: The Burrows", ["HeliosFallen"], dlc_group="ffs"),
    ...
    "FFSBossFight": Borderlands2RegionData("FFSBossFight", 30, 30, "Travel: FFS Boss Fight", ["WrithingDeep"], dlc_group="ffs"),
    "WrithingDeep": Borderlands2RegionData("WrithingDeep", 30, 30, "Travel: Writhing Deep", [], dlc_group="ffs"),
