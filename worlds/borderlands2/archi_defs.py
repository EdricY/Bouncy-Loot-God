...
loc_data_table = {
    ...
    "Vending BadassCrater Forge: Torgue Vendor":                BL2ArchiData("BadassCrater", 15, other_req_regions=["PyroPetesBar"]),
    "Vending BadassCrater Forge: Ammo":                         BL2ArchiData("BadassCrater", 15),
    "Vending BadassCrater Forge: Meds":                         BL2ArchiData("BadassCrater", 15),
    "Vending TorgueArena Inner: Torgue Vendor":                 BL2ArchiData("TorgueArena", 15, other_req_regions=["PyroPetesBar"]),
    "Vending TorgueArena Inner: Ammo":                          BL2ArchiData("TorgueArena", 15),
    "Vending TorgueArena Inner: Meds":                          BL2ArchiData("TorgueArena", 15),
    "Vending Beatdown Spawn: Torgue Vendor":                    BL2ArchiData("Beatdown", 15, other_req_regions=["PyroPetesBar"]),
    "Vending Beatdown Spawn: Ammo":                             BL2ArchiData("Beatdown", 15),
    "Vending Beatdown Spawn: Meds":                             BL2ArchiData("Beatdown", 15),
    "Vending Beatdown Underpass: Torgue Vendor":                BL2ArchiData("Beatdown", 15, other_req_regions=["PyroPetesBar"]),
