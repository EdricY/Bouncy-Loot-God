...
region_data_table: Dict[str, BorderlandsTPSRegionData] = {
    ...
    "Titan Industrial Facility":     BorderlandsTPSRegionData("Titan Industrial Facility", 12, 20, "Travel: Titan Industrial Facility", ["Titan Robot Production Plant", "Sub-Level 13"], story_req_regions=["The Meriff's Office", "Triton Flats"]),
    ...
    "Hyperion Hub of Heroism":       BorderlandsTPSRegionData("Hyperion Hub of Heroism", 15, 25, "Travel: Hyperion Hub of Heroism", ["Jack's Office", "Research and Development", "Veins of Helios"], story_req_regions=["Titan Robot Production Plant", "Concordia"]),
    ...
    "Veins of Helios":               BorderlandsTPSRegionData("Veins of Helios", 17, 25, "Travel: Veins of Helios", ["Lunar Launching Station"], story_req_regions=["Hyperion Hub of Heroism"]),
    ...
    "Eye of Helios":                 BorderlandsTPSRegionData("Eye of Helios", 18, 25, "Travel: Eye of Helios", [], story_req_regions=["Lunar Launching Station"]),
    "Vorago Solitude":               BorderlandsTPSRegionData("Vorago Solitude", 18, 30, "Travel: Vorago Solitude", ["Outfall Pumping Station"], story_req_regions=["Eye of Helios", "Triton Flats"]),
    ...
    "Tycho's Ribs":                  BorderlandsTPSRegionData("Tycho's Ribs", 19, 30, "Travel: Tycho's Ribs", ["Eleseer"], story_req_regions=["Outfall Pumping Station"]),
