...
region_data_table: Dict[str, Borderlands2RegionData] = {
    ...
    "BloodshotStronghold": Borderlands2RegionData("BloodshotStronghold", 12, "Travel: Bloodshot Stronghold", ["BloodshotRamparts"]),  # Travel: The Dust, Travel: Frostburn Canyon, Travel: Three Horns Valley
    "BloodshotRamparts": Borderlands2RegionData("BloodshotRamparts", 12, "Travel: Bloodshot Ramparts", ["TundraExpress"]),
    ...
    "FriendshipGulag": Borderlands2RegionData("FriendshipGulag", 10, "Travel: Friendship Gulag", []),  # Travel: The Dust, Travel: Bloodshot Stronghold
    ...
    "Bunker": Borderlands2RegionData("Bunker", 24,
        "Travel: The Bunker",
        ["ControlCoreAngel"]
    ),  # Travel: Wildlife Exploitation Preserve, Travel: Thousand Cuts, Travel: Opportunity
    ...
    "Backburner": Borderlands2RegionData("Backburner", 30, "Travel: The Backburner", ["DahlAbandon"]), # Travel: FFS Intro Sanctuary
    ...
    "TorgueArena": Borderlands2RegionData("TorgueArena", 15, "Travel: Torgue Arena", ["Beatdown"]),
    ...
    "SouthernRaceway": Borderlands2RegionData("SouthernRaceway", 15, "Travel: Southern Raceway", ["Forge"]),  # Travel: Torgue Arena Ring
    ...
    "DigistructPeak": Borderlands2RegionData("DigistructPeak", 0, "Travel: Digistruct Peak", ["DigistructPeakInner"]),
