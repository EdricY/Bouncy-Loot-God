...
gear_data_table = {
    ...
    "Unique Shield":                    BL2ArchiData("Menu", 0, tags=["from_license", "gear"], item_kind=progression, req_items=["License: Unique Shield"], alternates=[
                                            BL2ArchiData("HuntersGrotto", 30, req_items=["License: Common Pistol"], other_req_regions=["ScyllasGrove"]),
...
quest_data_table = {
    ...
    "Palling Around":                                       BL2ArchiData("HuntersGrotto", 30, req_items=["License: Common Pistol"], story_req_regions=["ScyllasGrove"]),
...
loc_data_table = {
    ...
    "Enemy: The Bulwark":                              BL2ArchiData("HuntersGrotto", 30, req_items=["License: Common Pistol"], story_req_regions=["ScyllasGrove"]),
