...
loc_data_table = {
    ...
    "Enemy: Dan (Splinter Group)":                   BL2ArchiData("BloodshotStronghold", 13, other_req_regions=["BloodshotRamparts", "FriendshipGulag"]),
    "Enemy: Lee (Splinter Group)":                   BL2ArchiData("BloodshotStronghold", 13, other_req_regions=["BloodshotRamparts", "FriendshipGulag"]),
    "Enemy: Mick (Splinter Group)":                  BL2ArchiData("BloodshotStronghold", 13, other_req_regions=["BloodshotRamparts", "FriendshipGulag"]),
    "Enemy: Ralph (Splinter Group)":                 BL2ArchiData("BloodshotStronghold", 13, other_req_regions=["BloodshotRamparts", "FriendshipGulag"]),
    "Enemy: Flinter (Splinter Group)":               BL2ArchiData("BloodshotStronghold", 13, other_req_regions=["BloodshotRamparts", "FriendshipGulag"], jump_z_req=291),
    ...
    "Symbol Fink'sSlaughter: Column":                          BL2ArchiData("FinksSlaughterhouse", 15),
    ...
    "Symbol ArenaTorgueRing: Arena Wall":                      BL2ArchiData("TorgueArena", 15, jump_z_req=355),
    "Symbol ArenaTorgueRing: Arena Ladder":                    BL2ArchiData("TorgueArena", 15),
    ...
    "Symbol SouthpawS&P: Reeth Area Engine":                   BL2ArchiData("SouthpawSteam&Power", 8, jump_z_req=566, other_req_regions=["Sanctuary"]),
    ...
    "Vending Fink'sSlaughter: Guns":                            BL2ArchiData("FinksSlaughterhouse", 0),
    "Vending Fink'sSlaughter: Ammo":                            BL2ArchiData("FinksSlaughterhouse", 0),
    "Vending Fink'sSlaughter: Meds":                            BL2ArchiData("FinksSlaughterhouse", 0),
    ...
    "Vending TheDust Ellie's: Meds":                            BL2ArchiData("Dust", 0), # can reach through the wall
    "Vending TheDust Ellie's: Ammo":                            BL2ArchiData("Dust", 0, other_req_regions=["FrostburnCanyon", "Sanctuary"]),
    ...
    "Vending Wurmwater TheRustyards: Guns":                     BL2ArchiData("Wurmwater", 15),
    ...
    "Vending TheLeviathan'sLair Body: Ammo":                    BL2ArchiData("LeviathansLair", 15), # is missable without chat travel command
    "Vending TheLeviathan'sLair Body: Meds":                    BL2ArchiData("LeviathansLair", 15), # is missable without chat travel command
    ...
    "Vending ArenaTorgueInner: Torgue Vendor":                  BL2ArchiData("TorgueArena", 15, req_rules=["Torgue Tokens Accessible"]),
    "Vending ArenaTorgueInner: Ammo":                           BL2ArchiData("TorgueArena", 15),
    "Vending ArenaTorgueInner: Meds":                           BL2ArchiData("TorgueArena", 15),
    ...
    "Vending TheBackburner Marcus: Guns":                       BL2ArchiData("Backburner", 15, other_req_regions=["DahlAbandon"]),
    "Vending TheBackburner Marcus: Ammo":                       BL2ArchiData("Backburner", 15, other_req_regions=["DahlAbandon"]),
    ...
    "Challenge TheBackburner: Fandir Fiction":                             BL2ArchiData("Backburner", 30, other_req_regions=["FFSBossFight", "LairOfInfiniteAgony"], req_items=["License: Unique Relic"], tags=["missable", "reg-based"]),
    "Challenge TheBackburner: Harmville":                                  BL2ArchiData("Backburner", 30, other_req_regions=["Burrows"], tags=["reg-based"]),
    ...
    "Challenge TheBurrows: Never Enough Tools":                            BL2ArchiData("Burrows", 30, other_req_regions=["FFSBossFight"], jump_z_req=625, tags=["reg-based"]),
    ...
    "Challenge Fink'sSlaughter: Cult of the Vault":                        BL2ArchiData("FinksSlaughterhouse", 15, tags=["reg-based"]),
    "Challenge TheBunker: BNK-3R Buster":                                  BL2ArchiData("Bunker", 24, other_req_regions=["ControlCoreAngel"], tags=["reg-based"]), # i think you have to beat cca for bunker to respawn
    ...
    "Challenge TheFridge: Stiff Competition":                              BL2ArchiData("Fridge", 15, jump_z_req=554, other_req_regions=["Highlands"], tags=["reg-based"]),
    "Challenge TheFridge: Trapped Rat":                                    BL2ArchiData("Fridge", 15, jump_z_req=554, other_req_regions=["Highlands"], tags=["reg-based"]),
    "Challenge TheFridge: Fairest of Them All":                            BL2ArchiData("Fridge", 15, other_req_regions=["Highlands"], tags=["reg-based"]),
    "Challenge TheFridge: It's Off to Hell We Go":                         BL2ArchiData("Fridge", 15, other_req_regions=["Highlands"], tags=["reg-based"]),
    ...
    "Challenge TheDust: If You're Not First, You're Last":                 BL2ArchiData("Dust", 15, other_req_regions=["Highlands"], tags=["reg-based"]),
    ...
    "Challenge SouthpawS&P: Boss Run":                                     BL2ArchiData("SouthpawSteam&Power", 8, other_req_regions=["Sanctuary"], tags=["reg-based"]),
    "Challenge SouthpawS&P: Cult of the Vault":                            BL2ArchiData("SouthpawSteam&Power", 8, jump_z_req=630, other_req_regions=["Sanctuary"], tags=["reg-based"]),
    ...
    "Challenge TheFridge: The Rakk Knight":                                BL2ArchiData("Fridge", 15, jump_z_req=554, other_req_regions=["Highlands"], tags=["reg-based"]),
    ...
    "Challenge ArenaTorgue: C4 Is For Cookie":                             BL2ArchiData("TorgueArena", 15, tags=["reg-based"]),
    "Challenge ArenaTorgue: Cult of the Vault":                            BL2ArchiData("TorgueArena", 15, jump_z_req=355, tags=["reg-based"]),
    "Challenge ArenaTorgue: It's Cool, I'm Part of the Crew":              BL2ArchiData("TorgueArena", 15, tags=["reg-based"]),
    "Challenge ArenaTorgue: Are You Not Entertained?":                     BL2ArchiData("TorgueArena", 50, tags=["reg-based"]),
    "Challenge ArenaTorgue: Burnin' Ring of Fire":                         BL2ArchiData("TorgueArena", 15, tags=["reg-based"]),
    ...
    "Chest TheFridge: Rakkman's Lair":                              BL2ArchiData("Fridge", 17, jump_z_req=554, other_req_regions=["Highlands"]),
    "Chest TheFridge: Stalker Hollow":                              BL2ArchiData("Fridge", 15, other_req_regions=["Highlands"]),
    "Chest TheFridge: Three Switch Electric Gate":                  BL2ArchiData("Fridge", 15, other_req_regions=["Highlands"]),
    "Chest TheFridge: Smashhead's Cave":                            BL2ArchiData("Fridge", 15, jump_z_req=554, other_req_regions=["Highlands"]),
    ...
    "Chest TheHolySpirits: The Stash":                              BL2ArchiData("HolySpirits", 18, jump_z_req=300),
    ...
    "Chest ArenaTorgueRing: First Arena Ladder":                    BL2ArchiData("TorgueArena", 15),
    "Chest ArenaTorgueRing: Maintenance Pipes":                     BL2ArchiData("TorgueArena", 15, jump_z_req=450),
    "Chest ArenaTorgueRing: Storage Area":                          BL2ArchiData("TorgueArena", 15, jump_z_req=470),
    "Chest ArenaTorgue: Arena Foyer":                               BL2ArchiData("TorgueArena", 15,),
    "Chest ArenaTorgueFinal: Arena Foyer":                          BL2ArchiData("TorgueArena", 15, other_req_regions=["Forge"]),
    "Chest PyroPete'sBar: Moxxi Cell #1":                           BL2ArchiData("PyroPetesBar", 15, jump_z_req=395), # jump into pipe to save Moxxi
    "Chest PyroPete'sBar: Moxxi Cell #2":                           BL2ArchiData("PyroPetesBar", 15, jump_z_req=395), # jump into pipe to save Moxxi
    ...
    "Chest Opportunity: Home Movies Upload Room":                   BL2ArchiData("Opportunity", 21, other_req_regions=["WildlifeExploitationPreserve", "ThousandCuts"], jump_z_req=390, tags=["missable"]),
    "Chest Opportunity: Voice Modulator Room":                      BL2ArchiData("Opportunity", 20, other_req_regions=["WildlifeExploitationPreserve", "ThousandCuts"], tags=["missable"]),
    ...
    "Chest SouthpawS&P: After Rouf":                                BL2ArchiData("SouthpawSteam&Power", 8, other_req_regions=["Sanctuary"]),
    "Chest SouthpawS&P: After Oney":                                BL2ArchiData("SouthpawSteam&Power", 8, jump_z_req=521, other_req_regions=["Sanctuary"]),
    ...
    "Chest Hunter'sGrotto: Destroyed Road":                         BL2ArchiData("HuntersGrotto", 30, other_req_regions=["ArdortonStation"], jump_z_req=380), # grenade jump expected
