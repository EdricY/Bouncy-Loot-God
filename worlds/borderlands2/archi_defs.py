...
quest_data_table = {
    ...
    "Rakkaholics Anonymous":                                BL2ArchiData("Dust", 19, req_rules=["Ranged Combat"], other_req_regions=["Sanctuary"], story_req_regions=["WildlifeExploitationPreserve"], associated_gear="Unique Pistol"),  # also Unique SniperRifle
