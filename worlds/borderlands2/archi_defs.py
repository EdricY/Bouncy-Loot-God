...
loc_data_table = {
    ...
    "Challenge Vehicles: Passive Aggressive":                              BL2ArchiData("Dust", 7, other_req_regions=["FrostburnCanyon", "Sanctuary"], tags=["general"]), # cannot spawn bandit technical until main story is progressed to this point confirmed
