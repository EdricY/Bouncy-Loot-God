...
quest_data_table = {
    ...
    "My First Gun":                                         BL2ArchiData("WindshearWaste", 0, tags=["story", "normal-only"]),
    ...
    "Blindsided":                                           BL2ArchiData("WindshearWaste", 1, is_non_gear_reward=True, tags=["story", "normal-only"]),
    "Cleaning up the Berg":                                 BL2ArchiData("SouthernShelf", 3, tags=["story", "normal-only"]),
...
loc_data_table = {
    ...
    **{f"Level {n} Reached": BL2ArchiData("Menu", n, tags=["aol_keep_req"]) for n in range(4, 81)},
    ...
    "Challenge Loot: Purple Reign":                                        BL2ArchiData("Menu", 6, tags=["general", "aol_keep_req"]),
    ...
    "Chest WindshearWaste: Blindsided":                             BL2ArchiData("WindshearWaste", 1, tags=["normal-only"]),
