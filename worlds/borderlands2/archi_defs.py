...
loc_data_table = {
    ...
    "Vending Backburner Marcus: Guns":                          BL2ArchiData("Backburner", 30, req_items=["Melee", "License: Common Pistol"], story_req_regions=["DahlAbandon"]),
    "Vending Backburner Marcus: Ammo":                          BL2ArchiData("Backburner", 30, req_items=["Melee", "License: Common Pistol"], story_req_regions=["DahlAbandon"]),
