...
gear_data_table = {
    ...
    "Legendary RocketLauncher":         BL2ArchiData("Menu", 0, is_gear=True, other_req_regions=["FrostburnCanyon", "Sanctuary"]),
...
loc_data_table = {
    ...
    "Generic: Varkid":                                          BL2ArchiData("TundraExpress", 13),
    ...
    "Generic: Skeleton":                                        BL2ArchiData("UnassumingDocks", 30),
