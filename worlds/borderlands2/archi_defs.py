...
quest_data_table = {
    ...
    "Commercial Appeal":                                    BL2ArchiData("Forge", 15, , jump_z_req=546, req_items=["License: Rare Shotgun", "Crouch"]),
...
loc_data_table = {
    ...
    "Enemy: Rakkman":                                BL2ArchiData("Fridge", 17, other_req_regions=["Highlands"], jump_z_req=630), # need verification of exact jump requirement, set to 630 default
    ...
    "Challenge BloodshotStronghold: Cult of the Vault":                    BL2ArchiData("BloodshotStronghold", 12, other_req_regions=["BloodshotRamparts", "FriendshipGulag"], jump_z_req=549, tags=["reg-based"]),
    "Challenge BloodshotStronghold: Give It a Whirl":                      BL2ArchiData("BloodshotStronghold", 12, tags=["reg-based"]),
    "Challenge HerosPass: When Nature Calls":                              BL2ArchiData("HerosPass", 29, jump_z_req=630, tags=["reg-based"]), # need confirmation for exact jump requirement, set to 630 default
    "Challenge HerosPass: Environmental Protection":                       BL2ArchiData("HerosPass", 29, jump_z_req=630, tags=["reg-based"]), # need confirmation for exact jump requirement, set to 630 default
    ...
    "Chest Fridge: Rakkman's Lair":                                 BL2ArchiData("Fridge", 15, other_req_regions=["Highlands"], jump_z_req=630), # need confirmation on exact jump requirement, set to 630 default for now
    ...
    "Chest HerosPass: Volcano Entrance":                            BL2ArchiData("HerosPass", 29, jump_z_req=630), # need confirmation on exact jump requirement to reach this chest, set to 630 default
