...
quest_data_table = {
    ...
    "Rising Action":                                        BL2ArchiData("Sanctuary", 15, other_req_regions=["ThreeHornsDivide"], story_req_regions=["EndOfTheLine"], is_non_gear_reward=True, tags=["story"]),
    ...
    "Bright Lights, Flying City":                           BL2ArchiData("Highlands", 16, other_req_regions=["ThreeHornsValley", "Fridge", "HighlandsOutwash", "Sanctuary"], is_non_gear_reward=True, tags=["story"]),
    ...
    "Where Angels Fear to Tread (Part 2)":                  BL2ArchiData("ControlCoreAngel", 24, other_req_regions=["Sanctuary"], is_non_gear_reward=True, tags=["story"]),
    ...
    "A Study in Scarlett":                                  BL2ArchiData("Wurmwater", 15, other_req_regions=["Oasis"], tags=["story"]),
    ...
    "Battle: The Death Race":                               BL2ArchiData("BadassCrater", 15, story_req_regions=["BadassCraterBar"], is_non_gear_reward=True, tags=["story"]),
    ...
    "Get Your Motor Running":                               BL2ArchiData("SouthernRaceway", 15, other_req_regions=["BadassCraterBar"], is_non_gear_reward=True, tags=["story"]),
    "Gas Guzzlers":                                         BL2ArchiData("SouthernRaceway", 15, other_req_regions=["BadassCraterBar"]),
    "Breaking and Entering":                                BL2ArchiData("Forge", 15, other_req_regions=["TorgueArena"], tags=["story"]),
    ...
    "Ell in Shining Armor":                                 BL2ArchiData("Forest", 30, req_items=["Melee"]),
    ...
    "Dwarven Allies":                                       BL2ArchiData("MinesOfAvarice", 30, req_items=["Melee"], is_non_gear_reward=True, tags=["story"]), # jump_z_req=450 for optional jumping puzzle
    ...
    "Winter is a Bloody Business":                          BL2ArchiData("HatredsShadow", 30, req_items=["Melee"]),
    ...
    "Pet Butt Stallion":                                    BL2ArchiData("FlamerockRefuge", 30, other_req_regions=["DragonKeep"], req_items=["Melee"], is_non_gear_reward=True),
...
loc_data_table = {
    ...
    "Enemy: Boll":                                   BL2ArchiData("ThreeHornsDivide", 10, story_req_regions=["FrostburnCanyon", "Sanctuary"]),
    "Enemy: Doc Mercy":                              BL2ArchiData("ThreeHornsValley", 8, req_rules=["Quest: Do No Harm"]),
    "Enemy: Assassin Oney":                          BL2ArchiData("SouthpawSteam&Power", 8, story_req_regions=["Sanctuary"]),
    "Enemy: Assassin Wot":                           BL2ArchiData("SouthpawSteam&Power", 8, story_req_regions=["Sanctuary"]),
    "Enemy: Assassin Reeth":                         BL2ArchiData("SouthpawSteam&Power", 8, story_req_regions=["Sanctuary"]),
    "Enemy: Assassin Rouf":                          BL2ArchiData("SouthpawSteam&Power", 8, story_req_regions=["Sanctuary"]),
    ...
    "Enemy: Gettle":                                 BL2ArchiData("Dust", 15, story_req_regions=["Highlands", "FriendshipGulag"]),
    "Enemy: Mobley":                                 BL2ArchiData("Dust", 15, story_req_regions=["Highlands", "FriendshipGulag"]),
    ...
    "Enemy: W4R-D3N":                                BL2ArchiData("BloodshotRamparts", 13, story_req_regions=["FriendshipGulag"]),
    "Enemy: Spycho":                                 BL2ArchiData("FrostburnCanyon", 28, story_req_regions=["AridNexusBoneyard"]),
    "Enemy: McNally":                                BL2ArchiData("Dust", 20, story_req_regions=["ThousandCuts", "WildlifeExploitationPreserve"]),
    "Enemy: Mick/Tector":                            BL2ArchiData("Dust", 19, story_req_regions=["Highlands", "HolySpirits"]),
    "Enemy: Dan (Splinter Group)":                   BL2ArchiData("BloodshotStronghold", 13, story_req_regions=["BloodshotRamparts", "FriendshipGulag"]),
    "Enemy: Lee (Splinter Group)":                   BL2ArchiData("BloodshotStronghold", 13, story_req_regions=["BloodshotRamparts", "FriendshipGulag"]),
    "Enemy: Mick (Splinter Group)":                  BL2ArchiData("BloodshotStronghold", 13, story_req_regions=["BloodshotRamparts", "FriendshipGulag"]),
    "Enemy: Ralph (Splinter Group)":                 BL2ArchiData("BloodshotStronghold", 13, story_req_regions=["BloodshotRamparts", "FriendshipGulag"]),
    "Enemy: Flinter (Splinter Group)":               BL2ArchiData("BloodshotStronghold", 13, story_req_regions=["BloodshotRamparts", "FriendshipGulag"], jump_z_req=291),
    "Enemy: Madame Von Bartlesby":                   BL2ArchiData("TundraExpress", 13),
    "Enemy: Prospector Zeke":                        BL2ArchiData("TundraExpress", 14, story_req_regions=["Highlands"], jump_z_req=550),
    "Enemy: Wilhelm":                                BL2ArchiData("EndOfTheLine", 13),
    "Enemy: Laney White":                            BL2ArchiData("Fridge", 17, story_req_regions=["Highlands"]),
    "Enemy: Rakkman":                                BL2ArchiData("Fridge", 17, jump_z_req=554, story_req_regions=["Highlands"]),
    "Enemy: SmashHead":                              BL2ArchiData("Fridge", 17, jump_z_req=554, story_req_regions=["Highlands"]),
    "Enemy: Shorty":                                 BL2ArchiData("Fridge", 17, story_req_regions=["Highlands"]),
    "Enemy: Sinkhole":                               BL2ArchiData("Fridge", 17, story_req_regions=["Highlands"]),
    "Enemy: Bloody (Laney Midget)":                  BL2ArchiData("Fridge", 17, story_req_regions=["Highlands"]),
    "Enemy: Crabby (Laney Midget)":                  BL2ArchiData("Fridge", 17, story_req_regions=["Highlands"]),
    "Enemy: Creepy (Laney Midget)":                  BL2ArchiData("Fridge", 17, story_req_regions=["Highlands"]),
    "Enemy: Dirty (Laney Midget)":                   BL2ArchiData("Fridge", 17, story_req_regions=["Highlands"]),
    "Enemy: Greedy (Laney Midget)":                  BL2ArchiData("Fridge", 17, story_req_regions=["Highlands"]),
    "Enemy: Sleazy (Laney Midget)":                  BL2ArchiData("Fridge", 17, story_req_regions=["Highlands"]),
    "Enemy: Tipsy (Laney Midget)":                   BL2ArchiData("Fridge", 17, story_req_regions=["Highlands"]),
    "Enemy: Old Slappy":                             BL2ArchiData("HighlandsOutwash", 15, story_req_regions=["Highlands"]),
    "Enemy: Gluttonous Thresher":                    BL2ArchiData("HighlandsOutwash", 16),
    "Enemy: Henry":                                  BL2ArchiData("Highlands", 17),
    "Enemy: Bagman":                                 BL2ArchiData("HolySpirits", 18, story_req_regions=["Highlands"]),
    ...
    "Enemy: Foreman Jasper":                         BL2ArchiData("Opportunity", 21, story_req_regions=["WildlifeExploitationPreserve", "ThousandCuts"]),
    "Enemy: Jack's Body Double":                     BL2ArchiData("Opportunity", 21, story_req_regions=["WildlifeExploitationPreserve", "ThousandCuts"]),
    ...
    "Enemy: Benny the Booster":                        BL2ArchiData("Oasis", 15, story_req_regions=["HaytersFolly"]),
    ...
    "Enemy: Hyperius":                                 BL2ArchiData("WashburneRefinery", 30, story_req_regions=["LeviathansLair"], tags=["raidboss"]),
    "Enemy: Master Gee":                               BL2ArchiData("HaytersFolly", 30, story_req_regions=["LeviathansLair"], tags=["raidboss"], jump_z_req=285),

    "Enemy: Pyro Pete":                                BL2ArchiData("PyroPetesBar", 15, tags=["story"]),
    "Enemy: Sully the Stabber":                        BL2ArchiData("Beatdown", 15, story_req_regions=["BadassCraterBar"]), # Eat Cookies and Crap Thunder requirement
    "Enemy: Hamhock":                                  BL2ArchiData("Beatdown", 15, story_req_regions=["BadassCraterBar"], tags=["missable"]), # Eat Cookies and Crap Thunder requirement
    ...
    "Enemy: Badassasaurus":                            BL2ArchiData("TorgueArena", 15, story_req_regions=["Forge"], jump_z_req=546, req_items=["Crouch"]),
    "Enemy: Piston":                                   BL2ArchiData("TorgueArena", 15, story_req_regions=["Forge"], jump_z_req=546, req_items=["Crouch"]),
    "Enemy: Pyro Pete the Invincible":                 BL2ArchiData("PyroPetesBar", 30, tags=["raidboss"], req_rules=["Quest: Long Way To The Top"]),
    ...
    "Enemy: King Aliah":                               BL2ArchiData("ImmortalWoods", 30), # do these guys respawn if the story is finished?
    ...
    "Challenge EridiumBlight: Save the Turrets":                           BL2ArchiData("EridiumBlight", 25, other_req_regions=["AridNexusBadlands"], tags=["missable", "reg-based", "story"]),
