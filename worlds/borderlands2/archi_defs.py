...
loc_data_table = {
    ...
    "Symbol Opportunity: Construction Site":                 BL2ArchiData("Opportunity", 20, jump_z_req=460), # Zer0 and Krieg too tall
    "Symbol Opportunity: Office Bridge":                     BL2ArchiData("Opportunity", 20, jump_z_req=465, req_items=["Crouch"]),
