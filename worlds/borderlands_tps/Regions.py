...
region_data_table: Dict[str, BorderlandsTPSRegionData] = {
    ...
    "Helios Station":                BorderlandsTPSRegionData("Helios Station", 0, 10, "", ["Serenity's Waste"]),
    "Serenity's Waste":              BorderlandsTPSRegionData("Serenity's Waste", 6, 15, "Travel: Serenity's Waste", ["Regolith Range", "Concordia"]),
    "Regolith Range":                BorderlandsTPSRegionData("Regolith Range", 4, 15, "Travel: Regolith Range", []),
    "Concordia":                     BorderlandsTPSRegionData("Concordia", 5, 15, "Travel: Concordia", ["Triton Flats", "The Meriff's Office", "Hyperion Hub of Heroism"], story_req_regions=["Serenity's Waste", "Regolith Range"]),
    ...
    "Outlands Spur":                 BorderlandsTPSRegionData("Outlands Spur", 0, 20, "Travel: Outlands Spur", ["Pity's Fall"]),
    ...
    "Sub-Level 13":                  BorderlandsTPSRegionData("Sub-Level 13", 15, 15, "Travel: Sub-Level 13", [], dlc_group="basegame_side", story_req_regions=["Titan Robot Production Plant"]),
    ...
    "Vorago Solitude":               BorderlandsTPSRegionData("Vorago Solitude", 18, 30, "Travel: Vorago Solitude", ["Outfall Pumping Station"]),
    ...
    "The Holodome":                  BorderlandsTPSRegionData("The Holodome", 25, 30, "Travel: The Holodome", [], dlc_group="holodome"),
    "Deck 13 ½":                     BorderlandsTPSRegionData("Deck 13 ½", 25, 30, "Travel: Deck 13 ½", ["The Nexus"], dlc_group="claptrap"),
