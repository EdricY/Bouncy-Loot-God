...
quest_data_table = {
    ...
    "Lost Souls":                                           BL2ArchiData("ImmortalWoods", 30, req_rules=["Ranged Combat"], is_non_gear_reward=True),
...
loc_data_table = {
    ...
    "Enemy: -=n00bkiller=-":                           BL2ArchiData("ImmortalWoods", 30, req_rules=["Ranged Combat"]),
