...
quest_data_table = {
    ...
    "Kickstart My Heart":                                   BL2ArchiData("Forge", 15, other_req_regions=["BadassCraterBar"], is_non_gear_reward=True, req_rules=["Quest: Battle: Twelve O'Clock High"], tags=["story", "unlocked_remove"]),
    "Commercial Appeal":                                    BL2ArchiData("Forge", 15, req_items=["License: Rare Shotgun"], req_rules=["Quest: Kickstart My Heart"]),
    "Long Way To The Top":                                  BL2ArchiData("TorgueArena", 15, other_req_regions=["BadassCraterBar"], story_req_regions=["Forge"], is_non_gear_reward=True, jump_z_req=546, req_items=["Crouch"], tags=["story"], req_rules=["Quest: Kickstart My Heart"]),
...
loc_data_table = {
    ...
    "Enemy: Anonymous Troll":                          BL2ArchiData("Forge", 15, req_rules=["Quest: Battle: Twelve O'Clock High"]),
    "Enemy: Uriah":                                    BL2ArchiData("Forge", 15, tags=["missable"]),
    "Enemy: Piston's Blimp":                           BL2ArchiData("Forge", 15, tags=["story"], req_rules=["Quest: Battle: Twelve O'Clock High"]),
    "Enemy: Badassasaurus":                            BL2ArchiData("TorgueArena", 15, story_req_regions=["Forge"], jump_z_req=546, req_items=["Crouch"], req_rules=["Quest: Kickstart My Heart"]), # this guy respawns
    "Enemy: Piston":                                   BL2ArchiData("TorgueArena", 15, story_req_regions=["Forge"], jump_z_req=546, req_items=["Crouch"], tags=["story"], req_rules=["Quest: Kickstart My Heart"]),
    ...
    "Challenge Forge: Air Mail":                                           BL2ArchiData("Forge", 50, tags=["reg-based"], req_rules=["Quest: Tier 3 Battle: Twelve O'Clock High"]),
    "Challenge Forge: Cult of the Vault":                                  BL2ArchiData("Forge", 15, jump_z_req=567, tags=["reg-based"], req_rules=["Quest: Battle: Twelve O'Clock High"]),
    "Challenge Forge: I DID Start the Fire":                               BL2ArchiData("Forge", 15, tags=["reg-based"]),
    "Challenge Forge: Parachutes Are for Pansies":                         BL2ArchiData("Forge", 15, tags=["reg-based"], req_rules=["Quest: Battle: Twelve O'Clock High"]),
