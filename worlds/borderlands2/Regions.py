...
region_data_table: Dict[str, Borderlands2RegionData] = {
    ...
    "DahlAbandon": Borderlands2RegionData("DahlAbandon", "Travel: Dahl Abandon", ["Burrows", "Mt.ScarabResearchCenter"]),
    "HeliosFallen": Borderlands2RegionData("HeliosFallen", "Travel: Helios Fallen", []),
    ...
    "SouthernRaceway": Borderlands2RegionData("SouthernRaceway", "Travel: Southern Raceway", ["Forge"]),
