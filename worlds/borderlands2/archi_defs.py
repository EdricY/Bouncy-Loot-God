...
loc_data_table = {
    ...
    "Challenge Wurmwater: Refined Tastes":                                 BL2ArchiData("Wurmwater", 15, req_rules=["Ranged Combat"], story_req_regions=["Rustyards"], tags=["reg-based"]),
    ...
    "Chest Wurmwater: Refined Tastes":                              BL2ArchiData("Wurmwater", 15, req_rules=["Ranged Combat"], story_req_regions=["Rustyards"]),
