...
quest_data_table = {
    ...
    "Denial, Anger, Initiative":                            BL2ArchiData("ImmortalWoods", 30, other_req_regions=["Forest"], tags=["story"]),
    "Dwarven Allies":                                       BL2ArchiData("ImmortalWoods", 30, other_req_regions=["MinesOfAvarice"], req_items=["Melee"], is_non_gear_reward=True, tags=["story"]), # jump_z_req=450 for optional jumping puzzle
