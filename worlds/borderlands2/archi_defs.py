...
quest_data_table = {
    ...
    "A-Hunting We Will Go":                                 BL2ArchiData("HuntersGrotto", 30, other_req_regions=["ArdortonStation"], req_items=["Melee"], is_non_gear_reward=True, tags=["story"]),
    ...
    "Now You See It":                                       BL2ArchiData("CandlerakksCrag", 30, req_items=["Melee"]),
    "Voracidous the Invincible":                            BL2ArchiData("CandlerakksCrag", 30, story_req_regions=["Terminus"], tags=["raidboss"], is_non_gear_reward=True),
}
