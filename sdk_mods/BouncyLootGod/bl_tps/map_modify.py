...
def create_pizza_item_pool(blg, check_name):
    sample_inv = unrealsdk.find_object("InventoryBalanceDefinition", "GD_DefaultProfiles.IntroEchos.BD_PrototypeIntroEcho")
    ...
    item_def = unrealsdk.construct_object(
        ...
        0,
        unrealsdk.find_object("UsableItemDefinition", "GD_Baroness_Items_crocus.Baroness.Head_Baron002")
    )
    ...
    #     pizza_mesh = unrealsdk.find_object("StaticMesh", "Prop_Details.Meshes.PizzaBoxWhole")
    unrealsdk.load_package("Deadsurface_Dynamic")
    pizza_mesh = unrealsdk.find_object("StaticMesh", "prop_rolandsresistance.Mesh.ResistancePoster") #Prop_Co_ShiftEvents.Meshes.PresentBox #Prop_Co_ShiftItems.Meshes.Pizza
    item_def.OverrideMaterial = unrealsdk.find_object("MaterialInstanceConstant", 'GD_Co_Followyourheartdata.Materials.Mati_Cat_INST')
    ...
    item_pool = unrealsdk.construct_object(
        ...
        0,
        unrealsdk.find_object("ItemPoolDefinition", "GD_Itempools.Runnables.Pool_FlameKnuckle")
    )
