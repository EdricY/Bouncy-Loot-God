...
region_data_table: Dict[str, BorderlandsTPSRegionData] = {
    ...
    "Titan Industrial Facility":     BorderlandsTPSRegionData("Titan Industrial Facility", 12, 20, "Travel: Titan Industrial Facility", ["Titan Robot Production Plant", "Sub-Level 13"], story_req_regions=["The Meriff's Office"]),
    ...
    "Vorago Solitude":               BorderlandsTPSRegionData("Vorago Solitude", 18, 30, "Travel: Vorago Solitude", ["Outfall Pumping Station"], story_req_regions=["Eye of Helios"]),
    ...
    "Abandoned Training Facility":   BorderlandsTPSRegionData("Abandoned Training Facility", 25, 30, "Travel: Abandoned Training Facility", [], story_req_regions=["Outlands Canyon"], dlc_group="shock_drop"),
    "The Holodome":                  BorderlandsTPSRegionData("The Holodome", 25, 30, "Travel: The Holodome", [], dlc_group="holodome", story_req_regions=["Serenity's Waste"]),
