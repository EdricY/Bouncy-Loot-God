...
gear_data_table = {
    ...
    "Legendary Shotgun":                BL2ArchiData("Menu", 0, tags=["from_license", "gear"], item_kind=progression, req_items=["License: Legendary Shotgun"], alternates=[
                                            BL2ArchiData("Fridge", 18, req_rules=["Quest: Note for Self-Person"]),
    ...
    "Legendary RocketLauncher":         BL2ArchiData("Menu", 0, tags=["from_license", "gear"], item_kind=progression, req_items=["License: Legendary RocketLauncher"], alternates=[
                                            BL2ArchiData("FrostburnCanyon", 13, req_rules=["Quest: Cult Following: The Enkindling"], other_req_regions=["Sanctuary"]),
                                            BL2ArchiData("WashburneRefinery", 30, tags=["raidboss"], other_req_regions=["LeviathansLair"]),
                                            BL2ArchiData("HallowedHollow", 15, req_rules=["Ranged Combat"]),
                                            BL2ArchiData("BadassCrater", 15, req_rules=["Torgue Tokens Accessible"]),
                                        ]),
...
quest_data_table = {
    ...
    "In Memoriam":                                          BL2ArchiData("ThreeHornsDivide", 10, req_rules=["Ranged Combat"], other_req_regions=["Sanctuary"], story_req_regions=["FrostburnCanyon"]),
    ...
    "Note for Self-Person":                                 BL2ArchiData("Fridge", 17, req_rules=["Quest: The Cold Shoulder"], jump_z_req=554),
    ...
    "Hidden Journals":                                      BL2ArchiData("Highlands", 17, other_req_regions=["Sanctuary"], is_non_gear_reward=True, req_rules=["Ranged Combat"]),
    "Torture Chairs":                                       BL2ArchiData("Sanctuary", 18, is_non_gear_reward=True, req_rules=["Quest: Hidden Journals"]),
    ...
    "Rakkaholics Anonymous":                                BL2ArchiData("Dust", 19, req_rules=["Ranged Combat"], other_req_regions=["Sanctuary"], story_req_regions=["WildlifeExploitationPreserve"], associated_gear="Unique Pistol", alternates=[ # also Unique SniperRifle
                                                                BL2ArchiData("Dust", 19, req_items=["Vehicle Fire"], other_req_regions=["Sanctuary"], story_req_regions=["WildlifeExploitationPreserve"])
                                                            ]),
    ...
    "Shoot This Guy in the Face":                           BL2ArchiData("ThousandCuts", 16, req_rules=["Ranged Combat"], story_req_regions=["WildlifeExploitationPreserve"], is_non_gear_reward=True),
    ...
    "Statuesque":                                           BL2ArchiData("Opportunity", 22, req_rules=["Ranged Combat"], other_req_regions=["Sanctuary"], story_req_regions=["WildlifeExploitationPreserve", "ThousandCuts"]),
    ...
    "Where Angels Fear to Tread":                           BL2ArchiData("ControlCoreAngel", 24, other_req_regions=["ThousandCuts", "Bunker", "Sanctuary"], req_rules=["Ranged Combat"], is_non_gear_reward=True, tags=["story"]),
    ...
    "The Hunger Pangs":                                     BL2ArchiData("GluttonyGulch", 15, req_items=["Melee", "License: Uncommon Pistol"]), # slag requirement?
    ...
    "Crazy About You":                                      BL2ArchiData("Rustyards", 15, req_rules=["Ranged Combat"], tags=["story", "unlocked_remove"]),
    ...
    "Tier 2 Battle: Bar Room Blitz":                        BL2ArchiData("PyroPetesBar", 30, is_non_gear_reward=True),
    ...
    "Tier 2 Battle: The Death Race":                        BL2ArchiData("BadassCrater", 30, story_req_regions=["BadassCraterBar"], is_non_gear_reward=True),
    ...
    "Battle: Twelve O' Clock High":                         BL2ArchiData("Forge", 15, req_rules=["Ranged Combat"], is_non_gear_reward=True, tags=["story", "unlocked_remove"]),
    "Tier 2 Battle: Twelve O' Clock High":                  BL2ArchiData("Forge", 30, req_rules=["Quest: Battle: Twelve O' Clock High"], is_non_gear_reward=True),
    "Tier 3 Battle: Twelve O' Clock High":                  BL2ArchiData("Forge", 50, req_rules=["Quest: Tier 2 Battle: Twelve O' Clock High"], is_non_gear_reward=True),
    "Tier 3 Rematch: Twelve O' Clock High":                 BL2ArchiData("Forge", 50, req_rules=["Quest: Tier 3 Battle: Twelve O' Clock High"], is_non_gear_reward=True),
    ...
    "Post-Crumpocalyptic":                                  BL2ArchiData("FlamerockRefuge", 30, req_rules=["Ranged Combat"], other_req_regions=["UnassumingDocks", "Forest", "MinesOfAvarice", "LairOfInfiniteAgony"], is_non_gear_reward=True, jump_z_req=533),
    ...
    "Lost Souls":                                           BL2ArchiData("ImmortalWoods", 30, is_non_gear_reward=True, req_items=["License: Common Pistol"]), # fire requirement
    ...
    "A Hard Place":                                         BL2ArchiData("Burrows", 30, other_req_regions=["Backburner", "DahlAbandon"], req_rules=["Quest: Spore Chores", "Ranged Combat"], is_non_gear_reward=True, tags=["story", "unlocked_remove"]),
...
loc_data_table = {
    ...
    "Enemy: Incinerator Clayton":                    BL2ArchiData("FrostburnCanyon", 13, req_rules=["Quest: Cult Following: The Enkindling"], story_req_regions=["Sanctuary"]),
    ...
    "Enemy: Laney White":                            BL2ArchiData("Fridge", 17, other_req_regions=["Sanctuary"], req_rules=["Quest: The Cold Shoulder"]),
    "Enemy: Rakkman":                                BL2ArchiData("Fridge", 17, other_req_regions=["Sanctuary"], req_rules=["Quest: Note for Self-Person"]),
    "Enemy: SmashHead":                              BL2ArchiData("Fridge", 17, other_req_regions=["Sanctuary"], req_rules=["Quest: Note for Self-Person"]),
    "Enemy: Shorty":                                 BL2ArchiData("Fridge", 17, other_req_regions=["Sanctuary"], req_rules=["Quest: The Cold Shoulder"]),
    "Enemy: Sinkhole":                               BL2ArchiData("Fridge", 17, other_req_regions=["Sanctuary"], req_rules=["Quest: The Cold Shoulder"]),
    "Enemy: Bloody (Laney Midget)":                  BL2ArchiData("Fridge", 17, other_req_regions=["Sanctuary"], req_rules=["Quest: The Cold Shoulder"]),
    "Enemy: Crabby (Laney Midget)":                  BL2ArchiData("Fridge", 17, other_req_regions=["Sanctuary"], req_rules=["Quest: The Cold Shoulder"]),
    "Enemy: Creepy (Laney Midget)":                  BL2ArchiData("Fridge", 17, other_req_regions=["Sanctuary"], req_rules=["Quest: The Cold Shoulder"]),
    "Enemy: Dirty (Laney Midget)":                   BL2ArchiData("Fridge", 17, other_req_regions=["Sanctuary"], req_rules=["Quest: The Cold Shoulder"]),
    "Enemy: Greedy (Laney Midget)":                  BL2ArchiData("Fridge", 17, other_req_regions=["Sanctuary"], req_rules=["Quest: The Cold Shoulder"]),
    "Enemy: Sleazy (Laney Midget)":                  BL2ArchiData("Fridge", 17, other_req_regions=["Sanctuary"], req_rules=["Quest: The Cold Shoulder"]),
    "Enemy: Tipsy (Laney Midget)":                   BL2ArchiData("Fridge", 17, other_req_regions=["Sanctuary"], req_rules=["Quest: The Cold Shoulder"]),
    ...
    "Enemy: Pumpkin Kingpin":                          BL2ArchiData("HallowedHollow", 15, req_rules=["Ranged Combat"]),
    "Enemy: Jacques O'Lantern":                        BL2ArchiData("HallowedHollow", 15, req_rules=["Ranged Combat"]),
    "Enemy: Cryptkeeper Clark":                        BL2ArchiData("HallowedHollow", 15, req_rules=["Ranged Combat"]),
    ...
    "Enemy: Chef Brulee":                              BL2ArchiData("GluttonyGulch", 15, req_rules=["Quest: The Hunger Pangs"]),
    "Enemy: Chef Bork Bork":                           BL2ArchiData("GluttonyGulch", 15, req_rules=["Quest: The Hunger Pangs"]),
    "Enemy: Wattle Gobbler":                           BL2ArchiData("GluttonyGulch", 15, req_rules=["Quest: The Hunger Pangs"]),
    ...
    "Enemy: Strip, Tribute of Southern Shelf":         BL2ArchiData("GluttonyGulch", 15, req_rules=["Quest: The Hunger Pangs"]),
    "Enemy: Flay, Tribute of Southern Shelf":          BL2ArchiData("GluttonyGulch", 15, req_rules=["Quest: The Hunger Pangs"]),
    "Enemy: Bailly, Tribute of Sawtooth Cauldron":     BL2ArchiData("GluttonyGulch", 15, req_rules=["Quest: The Hunger Pangs"]),
    "Enemy: Moretus, Tribute of Sawtooth Cauldron":    BL2ArchiData("GluttonyGulch", 15, req_rules=["Quest: The Hunger Pangs"]),
    "Enemy: Cynder, Tribute of Frostburn":             BL2ArchiData("GluttonyGulch", 15, req_rules=["Quest: The Hunger Pangs"]),
    "Enemy: Fuse, Tribute of Frostburn":               BL2ArchiData("GluttonyGulch", 15, req_rules=["Quest: The Hunger Pangs"]),
    "Enemy: Annie, Tribute of Lynchwood":              BL2ArchiData("GluttonyGulch", 15, req_rules=["Quest: The Hunger Pangs"]),
    "Enemy: Garret, Tribute of Lynchwood":             BL2ArchiData("GluttonyGulch", 15, req_rules=["Quest: The Hunger Pangs"]),
    "Enemy: Fiona, Tribute of Sanctuary":              BL2ArchiData("GluttonyGulch", 15, req_rules=["Quest: The Hunger Pangs"]),
    "Enemy: Max, Tribute of Sanctuary":                BL2ArchiData("GluttonyGulch", 15, req_rules=["Quest: The Hunger Pangs"]),
    ...
    "Enemy: Anonymous Troll":                          BL2ArchiData("Forge", 15, req_rules=["Quest: Say That To My Face"]),
    "Enemy: Uriah":                                    BL2ArchiData("Forge", 15, tags=["missable"]),
    "Enemy: Piston's Blimp":                           BL2ArchiData("Forge", 15, req_rules=["Quest: Kickstart My Heart"], tags=["unlocked_remove"]),
    "Enemy: Badassasaurus":                            BL2ArchiData("TorgueArena", 15, req_rules=["Quest: Long Way To The Top"], jump_z_req=546, req_items=["Crouch"]), # this guy respawns
    "Enemy: Piston":                                   BL2ArchiData("TorgueArena", 15, req_rules=["Quest: Long Way To The Top"], jump_z_req=546, req_items=["Crouch"]),
    ...
    "Enemy: -=n00bkiller=-":                           BL2ArchiData("ImmortalWoods", 30, req_rules=["Quest: Lost Souls"]),
    ...
    "Symbol Bunker: Backside":                                 BL2ArchiData("Bunker", 24, jump_z_req=575, alternates=[
                                                                   BL2ArchiData("Bunker", 24, req_rules=["Ranged Combat"]),
                                                                   BL2ArchiData("Bunker", 24, req_rules=["Quest: Where Angels Fear to Tread"]),
                                                               ]),
    ...
    "Symbol Forge: Smack Talker":                              BL2ArchiData("Forge", 15, jump_z_req=567, req_rules=["Quest: Battle: Twelve O' Clock High"]),
    "Symbol Forge: Lava":                                      BL2ArchiData("Forge", 15, req_rules=["Quest: Battle: Twelve O' Clock High"]),
    ...
    "Symbol DahlAbandon: Redclaw Rise Cliff":                  BL2ArchiData("DahlAbandon", 30, req_rules=["Quest: Spore Chores"], jump_z_req=415),
    ...
    "Vending GluttonyGulch Tribute Station: Guns":              BL2ArchiData("GluttonyGulch", 15, req_rules=["Quest: The Hunger Pangs"]),
    "Vending GluttonyGulch Tribute Station: Meds":              BL2ArchiData("GluttonyGulch", 15, req_rules=["Quest: The Hunger Pangs"]),
    "Vending GluttonyGulch Tribute Station: Ammo":              BL2ArchiData("GluttonyGulch", 15, req_rules=["Quest: The Hunger Pangs"]),
    ...
    "Vending Backburner Marcus: Guns":                          BL2ArchiData("Backburner", 30, req_rules=["Quest: The Oddest Couple"]),
    "Vending Backburner Marcus: Ammo":                          BL2ArchiData("Backburner", 30, req_rules=["Quest: The Oddest Couple"]),
    ...
    "Generic: Spore":                           BL2ArchiData("HuntersGrotto", 30, req_rules=["Ranged Combat"], alternates=[
                                                    BL2ArchiData("DahlAbandon", 30, req_rules=["Ranged Combat"]),
                                                ]),
    ...
    "Generic: Stabber Jabber":                  BL2ArchiData("GluttonyGulch", 15, req_items=["Melee"], tags=["missable"]),
    ...
    "Challenge LilithDLC: The Burdens of Creation":                        BL2ArchiData("Backburner", 30, req_rules=["Quest: Cadeuceus"], tags=["reg-based"]),
    "Challenge Backburner: Make Yourself At Home":                         BL2ArchiData("Backburner", 30, jump_z_req=551, req_rules=["Quest: Claptocurrency"], tags=["reg-based"]),
    ...
    "Challenge Backburner: Harmville":                                     BL2ArchiData("Backburner", 30, story_req_regions=["Burrows"], req_rules=["Quest: A Hard Place"], tags=["reg-based"]),
    ...
    "Challenge Forest: SO. CUTE.":                                         BL2ArchiData("Forest", 30, tags=["reg-based"], req_rules=["Ranged Combat"]),
    "Challenge Forest: Extreme Orc Makeover":                              BL2ArchiData("Forest", 30, req_items=["License: Common Pistol"], tags=["reg-based"]), # fire requirement
    ...
    "Challenge Combat: Knee-Deep in Brass":                                BL2ArchiData("Menu", 6, tags=["general"], req_rules=["Ranged Combat"]),
    ...
    "Challenge Fridge: Stiff Competition":                                 BL2ArchiData("Fridge", 15, req_rules=["Quest: Note for Self-Person"], tags=["reg-based"]),
    "Challenge Fridge: Trapped Rat":                                       BL2ArchiData("Fridge", 15, req_rules=["Quest: Note for Self-Person", "Ranged Combat"], tags=["reg-based"], alternates=[
                                                                               BL2ArchiData("Fridge", 15, req_rules=["Quest: Note for Self-Person"], req_items=["Crouch"]) # stock grenade at the correct angle can hit the fast travel
                                                                           ]),
    "Challenge Fridge: Fairest of Them All":                               BL2ArchiData("Fridge", 15, req_rules=["Quest: The Cold Shoulder"], tags=["reg-based"]),
    "Challenge Fridge: It's Off to Hell We Go":                            BL2ArchiData("Fridge", 15, req_rules=["Quest: The Cold Shoulder"], tags=["reg-based"]),
    ...
    "Challenge Highlands: Failure to Communicate":                         BL2ArchiData("Highlands", 16, tags=["reg-based"], req_rules=["Ranged Combat"]),
    ...
    "Challenge Opportunity: Down With Big, Handsome Brother":              BL2ArchiData("Opportunity", 20, tags=["reg-based"], req_rules=["Ranged Combat"]),
    ...
    "Challenge FrostburnCanyon: Totems of Fire":                           BL2ArchiData("FrostburnCanyon", 9, req_rules=["Ranged Combat"], tags=["reg-based"]),
    ...
    "Challenge Dust: I've Got a Crush on You":                             BL2ArchiData("Dust", 9, coop_type=1, tags=["reg-based"]),
    "Challenge Dust: The Van Is Damned":                                   BL2ArchiData("Dust", 9, tags=["reg-based"]),
    "Challenge Dust: If You're Not First, You're Last":                    BL2ArchiData("Dust", 9, tags=["reg-based"]),
    ...
    "Challenge Dust: Dust to Dust":                                        BL2ArchiData("Dust", 9, tags=["reg-based"]),
    "Challenge Fridge: The Rakk Knight":                                   BL2ArchiData("Fridge", 15, req_rules=["Quest: Note for Self-Person"], tags=["reg-based"]),
    ...
    "Challenge Vehicles: Passive Aggressive":                              BL2ArchiData("Dust", 7, story_req_regions=["FrostburnCanyon", "Sanctuary"], tags=["general"], alternates=[
                                                                               BL2ArchiData("DahlAbandon", 30, story_req_regions=["FrostburnCanyon", "Sanctuary", "Dust"])
                                                                           ]),
    ...
    "Challenge Forge: Air Mail":                                           BL2ArchiData("Forge", 50, req_rules=["Quest: Tier 3 Battle: Twelve O' Clock High"], tags=["reg-based"]),
    "Challenge Forge: Cult of the Vault":                                  BL2ArchiData("Forge", 15, req_rules=["Quest: Battle: Twelve O' Clock High"], jump_z_req=567, tags=["reg-based"]),
    "Challenge Forge: I DID Start the Fire":                               BL2ArchiData("Forge", 15, tags=["reg-based"]),
    "Challenge Forge: Parachutes Are for Pansies":                         BL2ArchiData("Forge", 15, req_rules=["Quest: Battle: Twelve O' Clock High"], tags=["reg-based"]),
    ...
    "Challenge HammerlockDLC: Savage Bloody Savage":                       BL2ArchiData("HuntersGrotto", 30, tags=["general"], alternates=[
                                                                                BL2ArchiData("WamBamIsland", 15)
    ]),
    ...
    "Challenge ScyllasGrove: Rakk Forest":                                 BL2ArchiData("ScyllasGrove", 30, tags=["reg-based"], req_rules=["Ranged Combat"]),
    ...
    "Chest Fridge: Rakkman's Lair":                                 BL2ArchiData("Fridge", 17, req_rules=["Quest: Note for Self-Person"]),
    "Chest Fridge: Stalker Hollow":                                 BL2ArchiData("Fridge", 15, req_rules=["Quest: Swallowed Whole"]),
    "Chest Fridge: Three Switch Electric Gate":                     BL2ArchiData("Fridge", 15, req_rules=["Quest: Swallowed Whole"]),
    "Chest Fridge: Smashhead's Cave":                               BL2ArchiData("Fridge", 15, req_rules=["Quest: Note for Self-Person"]),
    ...
    "Chest Bunker: Back Room":                                      BL2ArchiData("Bunker", 24, req_rules=["Ranged Combat"], alternates=[
                                                                        BL2ArchiData("Bunker", 24, req_rules=["Quest: Where Angels Fear to Tread"]),
                                                                    ]),
    ...
    "Chest GluttonyGulch: Wattle Gobbler Chest 3":                  BL2ArchiData("GluttonyGulch", 15, req_rules=["Quest: The Hunger Pangs"]),
    "Chest GluttonyGulch: Wattle Gobbler Chest 1":                  BL2ArchiData("GluttonyGulch", 15, req_rules=["Quest: The Hunger Pangs"]),
    "Chest GluttonyGulch: Freezeburn Fridge":                       BL2ArchiData("GluttonyGulch", 15),
    "Chest GluttonyGulch: Wattle Gobbler Chest 2":                  BL2ArchiData("GluttonyGulch", 15, req_rules=["Quest: The Hunger Pangs"]),
    ...
    "Chest HallowedHollow: Church of the Dead":                     BL2ArchiData("HallowedHollow", 15, req_rules=["Ranged Combat"]),
    ...
    "Chest Wurmwater: Refined Tastes":                              BL2ArchiData("Wurmwater", 15, req_rules=["Quest: Crazy About You"], story_req_regions=["Rustyards"]),
    ...
    "Chest Forge: Landing Pad Maintenance":                         BL2ArchiData("Forge", 15, req_rules=["Quest: Battle: Twelve O' Clock High"]),
    "Chest Forge: Forge Parkour":                                   BL2ArchiData("Forge", 15, jump_z_req=465, req_rules=["Quest: Battle: Twelve O' Clock High"]),
