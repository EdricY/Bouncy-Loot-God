...
class Borderlands2World(World):
    ...
    def fill_slot_data(self):
        return {
            ...
            "remove_ffs_checks": self.options.remove_ffs_checks,
            "remove_tina_checks": self.options.remove_tina_checks,
            "remove_torgue_checks": self.options.remove_torgue_checks,
            "remove_scarlett_checks": self.options.remove_scarlett_checks,
            "remove_hammerlock_checks": self.options.remove_hammerlock_checks,
            "remove_digi_peak_checks": self.options.remove_digi_peak_checks,
            "remove_headhunter_checks": self.options.remove_headhunter_checks,
            "remove_base_game_checks": self.options.remove_base_game_checks,
            "remove_specific_region_checks": self.options.remove_specific_region_checks,
            "remove_coop_checks": self.options.remove_coop_checks,
            "remove_raidboss_checks": self.options.remove_raidboss_checks,
            "max_level_checks": self.options.max_level_checks,
